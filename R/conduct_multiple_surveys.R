...
conduct_multiple_surveys <- structure(
function # Conduct multiple simulations of a survey

  ###############################################################################
  # File:  conduct_multiple_surveys.R
  ...
  (n_sims,  ##<<The number of simulations to be conducted in the simulation of interest.
